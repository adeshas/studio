...
export default function About() {
  return (
    <section id="about-us" className="w-full py-12 md:py-24 lg:py-32 bg-background" aria-labelledby="about-us-heading">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-24 items-center">
          <div className="space-y-4">
            <h2 id="about-us-heading" className="text-3xl font-bold font-headline tracking-tighter sm:text-5xl">About Us</h2>
